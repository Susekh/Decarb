...
export default function Hero() {
  return (
    <section className="pt-20 bg-white min-h-screen flex flex-col">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex-1 flex flex-col">
        {/* Main Content */}
        <div className="text-center pt-16 pb-8">
          <h1 className="text-6xl lg:text-7xl xl:text-8xl font-serif font-normal text-gray-900 leading-tight mb-6">
