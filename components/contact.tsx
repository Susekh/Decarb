      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            At Decarb, we believe that meaningful change begins with a
            conversation. Whether you&#39;re looking to enhance your
            sustainability practices, adopt climate-smart business strategies,
            or explore decarbonization opportunities — we&#39;re here to support
            your goals with clear, customized guidance. Our team is ready to
            collaborate with businesses of all sizes, across sectors, to
            co-create solutions that are environmentally responsible and
            economically sound.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
            ...
            <div className="bg-gray-900 rounded-3xl p-10 text-white">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                Schedule a free consultation to discuss your sustainability
          ...
          <div className="bg-gray-50 rounded-3xl p-10">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Have a query, proposal, or idea you&#39;d like to discuss? Share
              it with us by filling out the form below. We&#39;ll get back to
              you promptly.
            </p>
